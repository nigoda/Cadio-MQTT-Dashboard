...
def make_logo_transparent(img_path):
    ...
    # A pixel is considered "near-white" background if R, G, B are all > 235
    def is_bg_color(x, y):
        r, g, b, a = pixels[x, y]
    ...
    if bg_pixel_count > 0:
        ...
        print(f"Successfully removed white background! Keyed out {bg_pixel_count} connected border pixels.")
    else:
        print("No connected border background pixels found.")

if __name__ == "__main__":
    make_logo_transparent("static/Logo.png")
