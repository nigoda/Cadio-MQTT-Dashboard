...
//  Kept as raw string literals for readability.
// =============================================================================
#pragma once

// ---------------------------------------------------------------------------
//  SETUP PAGE — shown in AP (provisioning) mode
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
//  STATUS / DASHBOARD PAGE — shown on local LAN IP in normal mode
// ---------------------------------------------------------------------------
...
<title>Nivixsa ESP32 Status</title>
<style>
  *{box-sizing:border-box;margin:0;padding:0}
...
<div class="grid">
  ...
  <div class="card">
    ...
    <div class="stat"><span class="lbl">Chip</span><span class="val">ESP32</span></div>
  </div>
